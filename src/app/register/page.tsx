      ...
      <div className="bg-white p-10 rounded-2xl shadow-2xl w-full max-w-lg backdrop-blur-sm">
        ...
        <form onSubmit={register} className="space-y-5">
          ...
          <button 
            type="submit"
            disabled={loading}
            className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-4 py-4 w-full rounded-xl font-bold text-lg hover:from-green-700 hover:to-emerald-700 transform hover:scale-[1.02] transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
          >
            {loading ? (
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600">
            ...
            <Link href="/login" className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600 font-bold hover:underline">
              Sign in here
            </Link>
          </p>
        </div>
